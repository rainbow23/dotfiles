-- bookmarks.nvim 設定（プラグインロード後に require すること）
-- ロード前に必要なモンキーパッチは plugins/bookmarks.lua の init（rc.patches.bookmarks）で適用
...
map('n', 'ml', function()
  ...
  require('telescope').extensions.bookmarks.list({
    ...
    attach_mappings = function(prompt_bufnr, pmap)
      ...
      -- <C-l>（レイアウト切替）は config/telescope.lua の defaults.mappings で全 picker 共通に定義済み
